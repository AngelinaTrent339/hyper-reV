...
enum class hypercall_type_t : std::uint64_t {
  ...
  // Syscall interception hypercalls (hypervisor-level, no SSDT needed!)
  enable_syscall_intercept,  // Enable syscall logging at hypervisor level
  disable_syscall_intercept, // Disable syscall logging
